...
function homePage() {
	jQuery('.menu .transition_link a[href="#home"]').trigger('click');
}
function aboutPage() {
	jQuery('.menu .transition_link a[href="#about"]').trigger('click');
}
function publicationPage() {
	jQuery('.menu .transition_link a[href="#publications"]').trigger('click');
}
function patentsPage() {
	jQuery('.menu .transition_link a[href="#patents"]').trigger('click');
}
function contactPage() {
	jQuery('.menu .transition_link a[href="#contact"]').trigger('click');
}
